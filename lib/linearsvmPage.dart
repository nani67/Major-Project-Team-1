...
void main() => runApp(LinearSVM());

class LinearSVM extends StatelessWidget {
  LinearSVM({Key key, this.noOfColumns, this.columnNames}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: LinearSVMStateful(
        title: "Linear SVM Designing",
...
class LinearSVMStateful extends StatefulWidget {
  LinearSVMStateful({Key key, this.title, this.noOfColumns, this.columnNames}) : super(key: key);
  final String title;
  final int noOfColumns;
  final List<dynamic> columnNames;

  State<LinearSVMStateful> createState() => LinearSVMState();
}

class LinearSVMState extends State<LinearSVMStateful> {
...
dump(svClassifierLinear, 'linearsvm.joblib')''';
...
svClassifier = load('linearsvm.joblib')
dataset = pd.read_csv("${controllerForPredictionDatasetName.text}")
