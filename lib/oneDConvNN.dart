...
void main() => runApp(OneDNN());

class OneDNN extends StatelessWidget {
  OneDNN({Key key, this.noOfColumns, this.columnNames}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: OneDNNStateful(
        title: "1D Convolution Neural Network Designing",
...
class OneDNNStateful extends StatefulWidget {
  OneDNNStateful({Key key, this.title, this.noOfColumns, this.columnNames}) : super(key: key);
  final String title;
  final int noOfColumns;
  final List<String> columnNames;

  State<OneDNNStateful> createState() => OneDNNState();
}

class OneDNNState extends State<OneDNNStateful> {
